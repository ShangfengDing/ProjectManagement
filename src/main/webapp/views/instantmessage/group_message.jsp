...
<style>
    ...
    @media (min-width: 1200px){
        #link-picture {margin-left: 1063px}
    }
    @media  (min-width: 992px) and (max-width: 1199px){
        #link-picture {margin-left: 863px}
    }
    @media (min-width: 741px) and (max-width: 991px){
        #link-picture {margin-left: 643px}
    }
    @media (min-width: 475px) and (max-width: 740px){
        #link-picture {margin-left: 373px}
    }
    @media (min-width: 376px) and (max-width: 474px){
        #link-picture {margin-left: 304px}
    }
    @media (min-width: 361px) and (max-width: 375px){
        #link-picture {margin-left: 268px}
    }
    @media (max-width: 360px){
        #link-picture {margin-left: 253px}
    }
...
<div class="front-inner front-inner-media" style="padding-bottom: 0px;padding-top: 0px">
    <div class="container" style="padding-left: 0px;padding-right: 0px;padding-bottom:135px">
        ...
        <div id="show-message-area" style=""></div>
    ...
    <div style="position: fixed;bottom: 0;width: 100%;z-index: 100;background-color: #e7e7e7">
        <div class="container" style="padding-left: 6px; padding-right: 6px">
            <div class="text-right" style="padding-top: 10px">
                <form id="link-picture" action="task/uploadTaskPic" method="post" class="fr-file-upload" enctype="multipart/form-data" style="position: absolute">
                    ...
                    <input type="file" accept="image/*" name="file" id="triggerpictureFile" style="opacity: 0; cursor: pointer; width: 100%; height: 17px;margin-top: -20px"/>
                ...
                <a href="javascript:void(0);" onclick="resizeFullText()"><span id="resizeFull" class="glyphicon glyphicon-resize-full" style="color: #777;font-size: 13.5px;font-weight: bold"></span></a>
                <a href="javascript:void(0);" onclick="resizeSmallText()"><span id="resizeSmall" class="glyphicon glyphicon-resize-small" style="color: #777;font-size: 17px;display: none;"></span></a>&nbsp;
            </div>

            <form id="textSender" class="form-horizontal" style="padding-top: 10px; display: block">
                <div class="form-group" style="position: relative;margin-bottom: 6px">
                    <div class="col-md-12" style="margin-bottom: 6px">
                        <textarea class="form-control" style="border-style:none;height: auto;resize:none;" id="message-normal-textarea" rows="1" placeholder="按Enter发出消息"></textarea>
                        <%--<textarea class="form-control" style="display: none;height: 600px" id="message-sizeFull-textarea" placeholder="按Enter发出消息"></textarea>--%>
                    </div>
