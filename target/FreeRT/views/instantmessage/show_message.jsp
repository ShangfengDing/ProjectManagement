        ...
        <table class="table" style="margin-bottom: 0px; border-collapse: separate; border-spacing:6px">
            ...
            <tr>
                <td style="border-top: 0px">
                    <div id="show-initial-time" style="text-align: center;color: #969696"><s:date name="MessageList[0].time" format="yyyy-MM-dd HH:mm"/></div>
                </td>
            </tr>
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div style="font-size: 13px; margin-top: 2px">
                                            ...
                                            <span class="front-top-right pull-right">
                                                    ...
                                                    <a href="javascript:void(0);" onclick="setCommentDisplay(<s:property value='id'/>)">评论<span style="padding-left:3px;top:3px" id="commenicon<s:property value="id"/>" class="glyphicon glyphicon-chevron-down"/></a>&nbsp;
                                                </span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div style="font-size: 13px; margin-top: 2px; color: #777">
                                            ...
                                            <span class="front-top-right pull-right">
                                                    <s:if test="like==false">
                                                        <a id="likeIt<s:property value='id'/>" href="javascript:void(0)" onclick="likeIt(<s:property value='id'/>,1);">赞</a>
                                                    </s:if>
                                                    <s:else>
                                                        <a id="likeIt<s:property value='id'/>" href="javascript:void(0)" onclick="likeIt(<s:property value='id'/>,1);" style="color: #ff542d">赞</a>
                                                    </s:else>
...
<script>
    $(document).ready(function(){
        ...
        if('<s:property value="MessageList.size()"/>'!='0') {
            // console.log("10");
            chatlatestAjax('<s:date name="MessageList[MessageList.size()-1].time" format="yyyy-MM-dd HH:mm:ss"/>');
        }else{
